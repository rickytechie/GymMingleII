...
export const DEMO_PROFILES: DemoProfile[] = [
  ...
  },
  {
    ...
    mingleCoins: { ...createFreeAccount(), balance: 640, lifetimeEarned: 2100, lifetimeSpent: 1460, tier: PremiumTier.Premium, unlockedFeatures: [PremiumFeature.AdvancedChat, PremiumFeature.UnlimitedLikes, PremiumFeature.VenueInsights, PremiumFeature.ReadReceipts, PremiumFeature.LifestyleFilters] },
    premiumFeatures: [PremiumFeature.AdvancedChat, PremiumFeature.UnlimitedLikes, PremiumFeature.VenueInsights, PremiumFeature.ReadReceipts, PremiumFeature.LifestyleFilters],
  ...
  },
  {
    ...
    mingleCoins: { ...createFreeAccount(), balance: 1280, lifetimeEarned: 4500, lifetimeSpent: 3220, tier: PremiumTier.Elite, unlockedFeatures: [PremiumFeature.AdvancedChat, PremiumFeature.UnlimitedLikes, PremiumFeature.VenueInsights, PremiumFeature.ReadReceipts, PremiumFeature.PriorityMatching, PremiumFeature.IncognitoMode, PremiumFeature.VerifiedBadge, PremiumFeature.LifestyleFilters, PremiumFeature.KinkDiscovery] },
    premiumFeatures: [PremiumFeature.AdvancedChat, PremiumFeature.UnlimitedLikes, PremiumFeature.VenueInsights, PremiumFeature.ReadReceipts, PremiumFeature.PriorityMatching, PremiumFeature.IncognitoMode, PremiumFeature.VerifiedBadge, PremiumFeature.LifestyleFilters, PremiumFeature.KinkDiscovery],
