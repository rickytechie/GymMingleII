...
export const CITY_REGIONS: Record<string, RegionConfig> = {
  ...
  rochester: { label: 'Rochester', center: { latitude: 43.1566, longitude: -77.6088 }, radius: 10000 },
  syracuse: { label: 'Syracuse', center: { latitude: 43.0481, longitude: -76.1474 }, radius: 10000 },
  albany: { label: 'Albany', center: { latitude: 42.6526, longitude: -73.7562 }, radius: 8000 },
  philadelphia: { label: 'Philadelphia', center: { latitude: 39.9526, longitude: -75.1652 }, radius: 12000 },
  pittsburgh: { label: 'Pittsburgh', center: { latitude: 40.4406, longitude: -79.9959 }, radius: 10000 },
  baltimore: { label: 'Baltimore', center: { latitude: 39.2904, longitude: -76.6122 }, radius: 10000 },
  washington_dc: { label: 'Washington DC', center: { latitude: 38.9072, longitude: -77.0369 }, radius: 12000 },
  // -- Southeast --
  ...
  tampa: { label: 'Tampa', center: { latitude: 27.9506, longitude: -82.4572 }, radius: 12000 },
  atlanta: { label: 'Atlanta', center: { latitude: 33.7490, longitude: -84.3880 }, radius: 15000 },
  charlotte: { label: 'Charlotte', center: { latitude: 35.2271, longitude: -80.8431 }, radius: 12000 },
  ...
  richmond: { label: 'Richmond', center: { latitude: 37.5407, longitude: -77.4360 }, radius: 10000 },
  raleigh: { label: 'Raleigh', center: { latitude: 35.7796, longitude: -78.6382 }, radius: 12000 },
  // -- Midwest --
  ...
  cleveland: { label: 'Cleveland', center: { latitude: 41.4993, longitude: -81.6944 }, radius: 10000 },
  cincinnati: { label: 'Cincinnati', center: { latitude: 39.1031, longitude: -84.5120 }, radius: 10000 },
  columbus: { label: 'Columbus', center: { latitude: 39.9612, longitude: -82.9988 }, radius: 12000 },
  indianapolis: { label: 'Indianapolis', center: { latitude: 39.7684, longitude: -86.1581 }, radius: 12000 },
  st_louis: { label: 'St. Louis', center: { latitude: 38.6270, longitude: -90.1994 }, radius: 12000 },
  kansas_city: { label: 'Kansas City', center: { latitude: 39.0997, longitude: -94.5786 }, radius: 12000 },
  milwaukee: { label: 'Milwaukee', center: { latitude: 43.0389, longitude: -87.9065 }, radius: 10000 },
  minneapolis: { label: 'Minneapolis', center: { latitude: 44.9778, longitude: -93.2650 }, radius: 12000 },
  // -- Southwest --
  houston: { label: 'Houston', center: { latitude: 29.7604, longitude: -95.3698 }, radius: 15000 },
  dallas: { label: 'Dallas', center: { latitude: 32.7767, longitude: -96.7970 }, radius: 15000 },
  ...
  phoenix: { label: 'Phoenix', center: { latitude: 33.4484, longitude: -112.0740 }, radius: 15000 },
  tucson: { label: 'Tucson', center: { latitude: 32.2226, longitude: -110.9747 }, radius: 10000 },
  // -- West --
  ...
  san_diego: { label: 'San Diego', center: { latitude: 32.7157, longitude: -117.1611 }, radius: 12000 },
  san_jose: { label: 'San Jose', center: { latitude: 37.3382, longitude: -121.8863 }, radius: 10000 },
  sacramento: { label: 'Sacramento', center: { latitude: 38.5816, longitude: -121.4944 }, radius: 10000 },
  portland: { label: 'Portland', center: { latitude: 45.5152, longitude: -122.6784 }, radius: 12000 },
  seattle: { label: 'Seattle', center: { latitude: 47.6062, longitude: -122.3321 }, radius: 12000 },
  denver: { label: 'Denver', center: { latitude: 39.7392, longitude: -104.9903 }, radius: 12000 },
  las_vegas: { label: 'Las Vegas', center: { latitude: 36.1699, longitude: -115.1398 }, radius: 15000 },
  salt_lake_city: { label: 'Salt Lake City', center: { latitude: 40.7608, longitude: -111.8910 }, radius: 10000 },
  albuquerque: { label: 'Albuquerque', center: { latitude: 35.0853, longitude: -106.6056 }, radius: 10000 },
}
